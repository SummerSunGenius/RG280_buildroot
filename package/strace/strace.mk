...
STRACE_CONF_OPT = --enable-mpers=check
...
STRACE_CONF_OPT += --with-libunwind
else
STRACE_CONF_OPT += --without-libunwind
endif
...
STRACE_CONF_OPT += --with-libiberty=check
else
STRACE_CONF_OPT += --without-libiberty
endif
