...
MPLAYER_CONF_OPTSS    += --enable-alsa
else
MPLAYER_CONF_OPTSS    += --disable-alsa
endif

ifeq ($(BR2_ENDIAN),"BIG")
MPLAYER_CONF_OPTSS += --enable-big-endian
else
MPLAYER_CONF_OPTSS += --disable-big-endian
endif
...
MPLAYER_CONF_OPTSS += --disable-sdl
endif
...
MPLAYER_CONF_OPTSS += --disable-freetype
endif
...
MPLAYER_CONF_OPTSS += --enable-mplayer
else
MPLAYER_CONF_OPTSS += --disable-mplayer
endif

ifeq ($(BR2_PACKAGE_MPLAYER_MENCODER),y)
MPLAYER_CONF_OPTSS += --enable-mencoder
else
MPLAYER_CONF_OPTSS += --disable-mencoder
endif

ifeq ($(BR2_PACKAGE_TREMOR),y)
MPLAYER_DEPENDENCIES += tremor
MPLAYER_CONF_OPTSS += --disable-tremor-internal --enable-tremor
endif

ifeq ($(BR2_PACKAGE_LIBVORBIS),y)
MPLAYER_DEPENDENCIES += libvorbis
MPLAYER_CONF_OPTSS += --enable-libvorbis
endif

ifeq ($(BR2_PACKAGE_LIBMAD),y)
MPLAYER_DEPENDENCIES += libmad
MPLAYER_CONF_OPTSS += --enable-mad
else
MPLAYER_CONF_OPTSS += --disable-mad
endif

ifeq ($(BR2_PACKAGE_LIVE555),y)
MPLAYER_DEPENDENCIES += live555
MPLAYER_CONF_OPTSS += --enable-live
...
MPLAYER_CONF_OPTSS += --disable-live
endif
...
MPLAYER_CONF_OPTSS += --enable-armv5te
endif

ifeq ($(call qstrip,$(BR2_GCC_TARGET_ARCH)),armv6j)
MPLAYER_CONF_OPTSS += --enable-armv6
endif

ifeq ($(BR2_ARM_SOFT_FLOAT),)
ifeq ($(BR2_ARM_CPU_HAS_NEON),y)
MPLAYER_CONF_OPTSS += --enable-neon
...
MPLAYER_CONF_OPTSS += --disable-inet6
else
MPLAYER_CONF_OPTSS += --enable-inet6
endif
