...
WEBP_CONF_OPT += --enable-libwebpdemux
else
WEBP_CONF_OPT += --disable-libwebpdemux
endif

ifeq ($(BR2_PACKAGE_WEBP_MUX),y)
WEBP_CONF_OPT += --enable-libwebpmux
else
WEBP_CONF_OPT += --disable-libwebpmux
endif

ifeq ($(BR2_PACKAGE_GIFLIB),y)
WEBP_DEPENDENCIES += giflib
WEBP_CONF_OPT += --enable-gif
else
WEBP_CONF_OPT += --disable-gif
endif

ifeq ($(BR2_PACKAGE_LIBFREEGLUT),y)
WEBP_DEPENDENCIES += libfreeglut
WEBP_CONF_OPT += --enable-gl
else
WEBP_CONF_OPT += --disable-gl
endif
