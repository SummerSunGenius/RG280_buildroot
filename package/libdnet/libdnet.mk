...
LIBDNET_INSTALL_TARGET_OPTS = $(LIBDNET_MAKE_OPT) DESTDIR=$(TARGET_DIR) INSTALL_STRIP_FLAG=-s install-exec
LIBDNET_INSTALL_STAGING_OPTS = $(LIBDNET_MAKE_OPT) DESTDIR=$(STAGING_DIR) install
endif
